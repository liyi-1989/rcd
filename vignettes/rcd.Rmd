...
These two methods could be specified with the `density =` argument of the `rcd` function. Each of the estimation method comes with a tuning parameter. The bandwidth `bandwidth` for `method = "kde"` and `k` for `density = "knn"`. However, they are already set to their default values.
