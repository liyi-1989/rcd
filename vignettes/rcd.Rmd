...
These two methods could be specified with the `method =` argument of the `rcd` function. Each of the estimation method comes with a tuning parameter. The bandwidth `bw` for `method = "kde"` and `k` for `method = "knn"`. However, they are already set to their default values.
